...
```bash
kubectl create -f https://github.com/kubernetes-sigs/gateway-api/releases/download/v1.6.0/standard-install.yaml
```
...
首次创建后查看 Gateway 和 HTTPRoute 状态：

```bash
kubectl create -f gateway-demo.yaml
