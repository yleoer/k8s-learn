...
- [IPv4/IPv6 双栈](https://kubernetes.io/docs/concepts/services-networking/dual-stack/)
- [EndpointSlice](https://kubernetes.io/docs/concepts/services-networking/endpoint-slices/)
- [Kubernetes v1.33：继续从 Endpoints 迁移到 EndpointSlice](https://kubernetes.io/blog/2025/04/24/endpoints-deprecation/)
...
- [Endpoints API 参考](https://kubernetes.io/docs/reference/kubernetes-api/service-resources/endpoints-v1/)
- [kubectl expose 命令](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_expose/)
...
- [nginx 安全应用示例清单](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/service/networking/nginx-secure-app.yaml)
- [简单 Service 示例清单](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/service/simple-service.yaml)
