...
```bash
kubectl delete po -l app=node-nginx
kubectl get po -l app=node-nginx -w
```
...
```bash
kubectl get ds no-nginx -o wide
kubectl describe ds no-nginx
