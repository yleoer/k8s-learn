...
- [临时卷](https://kubernetes.io/docs/concepts/storage/ephemeral-volumes/)
- [本地临时存储](https://kubernetes.io/docs/concepts/storage/ephemeral-storage/)
- [持久卷](https://kubernetes.io/docs/concepts/storage/persistent-volumes/)
- [StorageClass](https://kubernetes.io/docs/concepts/storage/storage-classes/)
- [卷属性类](https://kubernetes.io/docs/concepts/storage/volume-attributes-classes/)
...
- [CSI 卷克隆](https://kubernetes.io/docs/concepts/storage/volume-pvc-datasource/)
- [NFS CSI 驱动](https://github.com/kubernetes-csi/csi-driver-nfs)
- [NFS CSI 驱动快照示例](https://github.com/kubernetes-csi/csi-driver-nfs/tree/v4.13.4/deploy/example/snapshot)
