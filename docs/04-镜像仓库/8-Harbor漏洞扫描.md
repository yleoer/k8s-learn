...
- 联网环境（默认）：Trivy 自动下载 `trivy-db` 并缓存本地。Harbor 2.14 文档描述的渠道是 GitHub Release，匿名下载有每小时 60 次限流，可在 `harbor.yml` 的 `trivy` 段配置 `github_token` 提升配额；上游 trivy-db 实际每 6 小时构建一次，且已改经 `ghcr.io` 的 OCI 仓库分发，Harbor v2.15 起可在 `trivy` 段用 `db_repository` 指定数据库仓库。
...
- [Vulnerability Scanning](https://goharbor.io/docs/2.14.0/administration/vulnerability-scanning/)
- [Scan Individual Artifacts](https://goharbor.io/docs/2.14.0/administration/vulnerability-scanning/scan-individual-artifact/)
- [Scan All Artifacts](https://goharbor.io/docs/2.14.0/administration/vulnerability-scanning/scan-all-artifacts/)
- [Connect Harbor to Additional Vulnerability Scanners](https://goharbor.io/docs/2.14.0/administration/vulnerability-scanning/pluggable-scanners/)
- [Configure System-Wide CVE Allowlists](https://goharbor.io/docs/2.14.0/administration/vulnerability-scanning/configure-system-allowlist/)
- [Configure a Per-Project CVE Allowlist](https://goharbor.io/docs/2.14.0/working-with-projects/project-configuration/configure-project-allowlist/)
- [Configure Project Settings](https://goharbor.io/docs/2.14.0/working-with-projects/project-configuration/)
- [Harbor Configuration File](https://goharbor.io/docs/2.14.0/install-config/configure-yml-file/)
