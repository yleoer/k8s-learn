...
Harbor 升级可能修改 `harbor.yml` 和数据库 schema，升级前必须备份配置、数据库和 Registry 数据。官方 Harbor 2.14 升级指南覆盖从 v2.11.0 及之后版本迁移到 v2.14.0；更早版本应查对应版本的迁移指南。
...
回滚不是降级。Harbor 官方文档明确说明，回滚依赖升级前保留的旧版本 Harbor 文件和数据库备份；Harbor 不支持自动数据库降级。没有同一时间点的配置、数据库和 Registry 数据备份时，不应假设可以安全回退。
...
- [Harbor Configure Proxy Cache](https://goharbor.io/docs/2.14.0/administration/configure-proxy-cache/)
- [Harbor Configure Project Quotas](https://goharbor.io/docs/2.14.0/administration/configure-project-quotas/)
- [Harbor Audit Log](https://goharbor.io/docs/2.14.0/administration/audit-log/)
- [Harbor Log Rotation](https://goharbor.io/docs/2.14.0/administration/log-rotation/)
- [Harbor Upgrade and Migrate Data](https://goharbor.io/docs/2.14.0/administration/upgrade/)
- [Harbor Roll Back from an Upgrade](https://goharbor.io/docs/2.14.0/administration/upgrade/roll-back-upgrade/)
